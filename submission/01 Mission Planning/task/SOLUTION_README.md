...
I left the provided simulator source unchanged for submission. For local Docker compatibility, I keep OpenCV workarounds in the Docker helper files rather than editing `bx_grid_world.cpp`.
